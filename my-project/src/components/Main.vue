        ...
        <ul class="header-menu horizontal-list">
          <li>
            <a class="header-menu-tab" href="#1"
              ><span class="icon entypo-cog scnd-font-color"></span>Settings</a
            >
          </li>
          <li>
      ...
      <div class="left-container container">
          ...
          <ul class="menu-box-menu">
            <li>
              <a class="menu-box-tab" href="#6"
                ><span class="icon fontawesome-envelope scnd-font-color"></span
                >Messages
                <div class="menu-box-number">24</div></a
              >
            </li>
            <li>
        ...
        <div class="donut-chart-block block">
          ...
          <div class="donut-chart">
            ...
            <p class="center-date">
              JUNE<br /><span class="scnd-font-color">2013</span>
            </p>
          </div>
          ...
          <ul class="profile-options horizontal-list">
            <li>
              <a class="comments" href="#40"
                ><p>
                  <span
                    class="icon fontawesome-comment-alt scnd-font-color"
                  ></span
                  >23
                </p></a
              >
            ...
            <li>
              <a class="likes" href="#42"
                ><p>
                  <span
                    class="icon fontawesome-heart-empty scnd-font-color"
                  ></span
                  >49
                </p></a
              >
        ...
        <div class="tweets block">
          ...
          <div class="tweet first">
            <p>
              ...
              played dad. On <a class="tweet-link" href="#17">@Quora</a>
            </p>
            <p>
              <a class="time-ago scnd-font-color" href="#18">3 minutes ago</a>
            </p>
          </div>
          <div class="tweet">
            <p>
              ...
              <a class="tweet-link" href="#19">#CreativeCloud</a>
            </p>
        ...
        <ul class="social block">
          ...
          <li>
            <a href="#52"
              ...
              <h2 class="googleplus titular">SHARE TO GOOGLE+</h2></a
            >
          </li>
        </ul>
      </div>
          ...
          <a class="fb-sign-in" href="58">
            <p>
              <span class="fb-border"
                ><span class="icon zocial-facebook"></span></span
